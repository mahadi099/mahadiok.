...
Security
Insights
open-source/Kashif.py
@MrJadugar
MrJadugar Add files via upload
 1 contributor
...
AUTHOR    : MAHADI HASAN JIHAD
FACEBOOK : MAHADI HASAN JIHAD
VERSION    : 1.1
                                   [THE DEAD USER]
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m MAHADI OK : \x1b[1;97m %s  \x1b[1;97mKB-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m MAHADI CP :\x1b[1;97m   %s \x1b[1;97mKB-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m MAHADI 2F :\x1b[1;97m   %s \x1b[1;97mKB-2F.txt' %
              (H, P, str(len(twf))))
